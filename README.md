...
✨ Features
Text Hashing: Generate hashes for any text input in real time.
File Hashing: Select a file to generate its hash value.
Multiple Algorithms: Supports MD5 and SHA-256.
User-Friendly Interface: Clean design with instant hash display.
